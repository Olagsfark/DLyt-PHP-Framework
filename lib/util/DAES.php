...
/**
 * A custom cryptography class; though bit slow, but works
 */
class DAES {
        // The number of 32-bit words comprising the plaintext and columns comrising the state matrix of an DAES cipher.
        private static $Nb = 4;
        // The number of 32-bit words comprising the cipher key in this DAES cipher.
        private $Nk;
        // The number of rounds in this DAES cipher.
        private $Nr;
        ...
        // The key schedule in this DAES cipher.
        private $w;
        // The state matrix in this DAES cipher with Nb columns and 4 rows
        private $s;
        // Determines the lenght of key z
        private $keyLength;


        /** constructs an DAES cipher using a specific key.
        */
